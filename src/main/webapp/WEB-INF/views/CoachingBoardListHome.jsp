...
<head>
	...
	<script>
		function list(page){
			location.href = "${path}/CoachingBoard/CoachingBoardList?id=${pageContext.request.remoteUser}&curPage="+page+"&searchOption-${map.searchOption}"+"&keyword=${map.keyword}";
		}
	</script>
</head>
			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="home">여기는 코칭 갤러리 홈입니다.
